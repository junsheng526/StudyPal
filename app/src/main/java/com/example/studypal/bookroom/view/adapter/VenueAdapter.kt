package com.example.studypal.bookroom.view.adapter
...
class VenueAdapter(private val onItemClick: (Venue) -> Unit) : RecyclerView.Adapter<VenueAdapter.VenueViewHolder>() {
